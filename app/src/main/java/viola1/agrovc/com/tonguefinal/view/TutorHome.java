...
public class TutorHome extends AppCompatActivity implements View.OnClickListener, NavigationView.OnNavigationItemSelectedListener{
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.complete_registration:{
                startActivity(new Intent(this,Tutor.class));
