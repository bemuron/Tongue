...
public class StudentSignUp extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id==R.id.help){
            Intent intent=new Intent(StudentSignUp.this, HelpCenter.class);
            startActivity(intent);
        }

        if (id==R.id.online_users){
            Intent intent=new Intent(StudentSignUp.this,AdminContact.class);
        ...
        if (item.getItemId() == android.R.id.home) {
            //finish();
            Intent intent=new Intent(StudentSignUp.this,Login.class);
            startActivity(intent);
        }
    ...
    public void signUpOnClick(View view){
        ...
        if(isValidUserInput()){
            ...
            new DataLoaderSignUp(StudentSignUp.this).userSignUp(reqBean);
    ...
    private boolean isValidUserInput() {
        ...
        if(!validator.isEmailValid(email)){
            ...
            MDToast mdToast = MDToast.makeText(StudentSignUp.this, AppErrors.INVALID_EMAIL,Toast.LENGTH_SHORT,MDToast.TYPE_ERROR);
        ...
        if(spinner_user_type.getSelectedItem().toString()==""){
            ...
            MDToast mdToast = MDToast.makeText(StudentSignUp.this,"Select cartegory",MDToast.TYPE_ERROR);
        ...
        if(!password.equals(confirm_password)){
            ...
            MDToast mdToast = MDToast.makeText(StudentSignUp.this,AppErrors.INVALID_PASSWORD_MISMATCH,MDToast.TYPE_ERROR);
            ...
            if(!validator.isPasswordValid(password)){
                ...
                MDToast mdToast = MDToast.makeText(StudentSignUp.this,AppErrors.INVALID_PASSWORD,MDToast.TYPE_ERROR);
    ...
    public class DataLoaderSignUp {
        ...
        public void userSignUp(ReqBeanSignup reqBean) {
            ...
            startProgressDialog();
            Call<ResBeanSignup> call = service.registerUserStudent(reqBean);
