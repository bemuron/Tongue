...
public class StudentLogin extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id==R.id.help)
        {
            ...
            //Intent intent=new Intent(StudentLogin.this,LoginActivity.class);
        ...
        if (id==R.id.online_users){
           ...
           // Intent intent=new Intent(StudentLogin.this, io.hypertrack.tutors.splashed.ActivitySplash.class);
    ...
    private void authenticateUser(final String email, final String password) {
        ...
        Call<ResBeanLogin> call = service.authenticateStudent(reqBean);
        call.enqueue(new Callback<ResBeanLogin>() {
            ...
            public void onResponse(Call<ResBeanLogin> call, Response<ResBeanLogin> response) {
                ...
                if(response.code() == AppNums.STATUS_COD_SUCCESS){
                    ...
                    if(resBean.getLogin_status().equalsIgnoreCase(Boolean.TRUE.toString())){
                        ...
                        //startActivity(new Intent(StudentLogin.this, SplashScreen.class));
                        finish();

                    }else{
                        //  Toast.makeText(Login.this,resBean.getError(),Toast.LENGTH_SHORT).show();
                        MDToast mdToast = MDToast.makeText(StudentLogin.this,resBean.getError(),Toast.LENGTH_SHORT, MDToast.TYPE_ERROR);

                        mdToast.show();
                    }
                }else if(response.code() == AppNums.STATUS_COD_FILE_NOT_FOUND){

                    generalMethods.showLocationDialog(StudentLogin.this, EnumAppMessages.LOGIN_ERROR_TITLE.getValue(),EnumAppMessages.ERROR_RESOURCE_NOT_FOUND.getValue());

                }else{

                    generalMethods.showLocationDialog(StudentLogin.this,EnumAppMessages.LOGIN_ERROR_TITLE.getValue(),EnumAppMessages.ERROR_INTERNAL_ERROR.getValue());
            ...
            public void onFailure(Call<ResBeanLogin> call, Throwable t) {
                ...
                if(t instanceof IOException){
                    generalMethods.showLocationDialog(StudentLogin.this,EnumAppMessages.LOGIN_ERROR_TITLE.getValue(), EnumAppMessages.ERROR_INTERNET_CONNECTION.getValue());
                }else {
                    generalMethods.showLocationDialog(StudentLogin.this,EnumAppMessages.LOGIN_ERROR_TITLE.getValue(),EnumAppMessages.ERROR_UNKNOWN_ERROR.getValue());
                }
            }
        });
    }
    ...
    private void storeUserProfileInformation(ResBeanUserProfile resBeanUserProfile, ResBeanLogin resBean) {
        ...
        try{
            ...
            final DBHandler dbHandler = DBHandler.getInstance(StudentLogin.this);
